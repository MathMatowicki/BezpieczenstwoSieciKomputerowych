...
namespace Bezpieczeństwo.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Algorithms(String key, int algorithm, int option, IFormFile file, String sequence)
        {
            ...
            List<String> result = launchAlgorithmZad1(code, key, algorithm, option);
            ViewBag.result = result;
        ...
        private List<String> launchAlgorithmZad1(String[] code, String key, int algorithm, int option)
        {
            List<String> result = new List<string>();
            switch (algorithm)
            {
