...
namespace UnitTests
{
    public class Tests
    {
        ...
        public void TestWeakKeys()
        {
            ...
            {
                0,   //klucz składający się z samych zer - 00 00 00 00 00 00 00 00
                18446744073709551615,    //klucz składający się z samych jedynek - maksymalna liczba na 64 bitach (2^64-1)
                72340172838076673,    //0101010101010101 szesnastkowo
                16204198716015505905,    //E0E0E0E0F1F1F1F1 szesnastkowo
                2170205184889655055    //1E1E1E1E0F0F0F0F szesnastkowo
            };
            DESkey dk = new DESkey();
